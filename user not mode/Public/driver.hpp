#pragma once
//I added this driver just for tests i dont recommend use this in paid/free projects
// credits to: jeremyud 
// This driver Comes from old sofmain base from 02/25
// 
#include <winternl.h>
#include <intrin.h>
#include <Windows.h>
...
inline bool read_buffer(uintptr_t address, void* buffer, size_t size) {
	Driver::ReadPhysicalMemory((PVOID)address, buffer, (DWORD)size);
	return true;
}
